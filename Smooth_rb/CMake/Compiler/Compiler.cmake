...
#-prof-use -profile-loops
    SET(CMAKE_CXX_FLAGS_RELEASE "-farray-notation -Ofast -xavx -no-prec-div -vec-report=1 -no-prec-sqrt -i-static -fno-alias -fno-exceptions -ipo -DNDEBUG" CACHE STRING
        ${CMAKE_FLAGS_HELP} FORCE)
