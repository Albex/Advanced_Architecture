...
First the code was compiled with the g++ compiler optimised at level 3, and analyzed with Intel VTunes profiler to identify the bottlenecks. The initial speed for the small size graph was $ $.

It appears that the initial program spend
